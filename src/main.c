...
int main(int argc, char **argv)
{
    ...
    ratr0_amiga_blit_fast(ctx, &tiles_ctx, 16, 16, 0, 16, 16, 16);
    ratr0_amiga_blit_fast(ctx, &tiles_ctx, 16, 32, 0, 0, 16, 16);
    ratr0_amiga_blit_fast(ctx, &tiles_ctx, 16, 48, 16, 16, 16, 16);
    ratr0_amiga_blit_fast(ctx, &tiles_ctx, 16, 64, 32, 0, 16, 16);
